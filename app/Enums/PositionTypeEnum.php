...
enum PositionTypeEnum: int implements EnumInterface
{
    use ConstantsTrait;
    ...
    public static function getLabels(): array
    {
        return [
            ...
            self::the_organizational_structure->value => __('the_organizational_structure'),
            self::committee->value                    => __('committee'),
        ];
    }
}
