...
return [
    ...
    */
    ...
    'civil_id_required_if'         => 'يجب عليك تحديد رقم الهوية',
    'residency_number_required_if' => 'يجب عليك تحديد رقم الاقامة',
    'ksa_phone_number'             => 'يجب عليك تحديد رقم هاتفك بشكل صحيح مثل 5xxxxxxxx',
    ...
    'exists'                       => 'حقل :attribute غير موجودٍ',
    ...
    'not_in'                       => 'حقل :attribute غير موجودٍ',
    'not_regex'                    => 'حقل :attribute نوعه غير موجودٍ',
    ...
    'string_error_input_validation' => 'يجب إدخال الإسم بشكل صحيح',
    ...
    */
    ...
    'attributes' => [
        ...
        'title'                              => 'العنوان',
        'published_at'                       => 'نشر في',
        'users_type'                         => 'نوع المستخدم',
        'residency_number'                   => 'رقم الهوية',
        'governance_list_id'                 => 'معرف قائمة الإدارة',
        'attachment'                         => 'الملف',
        "position_name"                      => "المسمى الوظيفى",
        "period"                             => "المدة",
        "image"                              => "الصورة",
        "country_code"                       => "كود البلد",
        "position_id"                        => "المسمى الوظيفى",
        "association_values"                 => "قيمنا",
        "association_objectives"             => "أهدافنا",
        "association_message"                => "رسالتنا",
        "association_visions"                => "رؤيتنا",
        "establishment_of_the_association"   => "تأسيس الجمعية",
        "association_about_description"      => "وصف عن الجمعية",
        "association_about_title"            => "عنوان عن الجمعية",
        "phone1"                             => "رقم الهاتف 1",
        "tasks"                              => "اختصاصات ومهام اللجنه",
        "birthdate"                          => "تاريخ الميلاد",
        'committees'                         => 'اللجان',
        'committees.*.id'                    => 'رقم اللجنة',
        'committees.*.tasks'                 => 'مهام اللجنة',
        'bmi_link'                           => "رابط ال BMI",
        "whatsapp_group"                     => "جروب الواتساب",
        "telegram_group"                     => "جروب التليجرام",
        'gender'                             => 'الجنس',
        'consulting'                         => 'الاستشارة',
        "clinic_location"                    => "موقع العيادة",
        "clinic_email"                       => "البريد الإلكترونى للعيادة",
        "file_type"                          => "نوع الملف",
